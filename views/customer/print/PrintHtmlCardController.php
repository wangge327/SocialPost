...
//        $useDefaultPrinter = ($qs['useDefaultPrinter'] === 'checked');
        ...
        $filePath = dirname(__FILE__). "/cache/".$qs['imageFileName'];
        ...
        $fileName =$qs['imageFileName'].'.png';
//        $fileName = 'ID_'.date('m-d-H-i-s').'-PW=2-PH=3.25'.'.png';
//        $fileName = 'ID_'.date('m-d-H-i-s').'-PW=2.125-PH=3.375'.'.png';
