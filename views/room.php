                    ...
                    <table class="table display companies-list" id="data-table" style="width: 92%;">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a class="send-to-server-click" data="bedid:{{ $bed_item->id }}|csrf-token:{{ csrf_token() }}" url="<?= url("Room@ChangeBedStatus"); ?>" warning-button="Continue" loader="true" href="" warning-title="Are you sure?" @if ($bed_item->status=="Vacant")
