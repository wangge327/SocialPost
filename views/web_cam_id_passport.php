...
<div class="avatararea" style="margin-top: 20px; padding: 20px 0;">
	...
	<div class="row">
		...
		<div class="imagearea col-lg-8 col-md-5 col-sm-12">
			<div class="avatarimage" id="drop-area">
				@if( empty($passports->path0) )
                <img src="/webcam/assets/img/avatar.jpg" alt="avatar"  id="avatarimage" />
				@else
                    @if(file_exists($_SERVER['DOCUMENT_ROOT']."/uploads/avatar/".$passports->path0))
                    <img src="/uploads/avatar/{{ $passports->path0 }}" alt="avatar"  id="avatarimage" />
                    @else
                    <img src="/webcam/assets/img/avatar.jpg" alt="avatar"  id="avatarimage" />
                    @endif
				@endif
    ...
    <div class="row">
        ...
        <div class="imagearea col-lg-8 col-md-5 col-sm-12">
            <div class="avatarimage" id="drop-area">
                @if( empty($passports->path1) )
                <img src="/webcam/assets/img/avatar.jpg" alt="avatar"  id="avatarimage" />
                @else
                @if(file_exists($_SERVER['DOCUMENT_ROOT']."/uploads/avatar/".$passports->path1))
                <img src="/uploads/avatar/{{ $passports->path1 }}" alt="avatar"  id="avatarimage" />
                @else
                <img src="/webcam/assets/img/avatar.jpg" alt="avatar"  id="avatarimage" />
                @endif
                @endif
