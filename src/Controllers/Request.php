        ...
        foreach($emails as $index => $email){
            ...
            $send = Mail::send(
                ...
                array(
                    ...
                    "buttonText" => "Sign Now",
                    "buttonLink" => $signingLink,
                    "message" => "You have been invited to sign a lease agreement by Hiawatha inc.<br> Click the link above to respond to the invite.<br><br>Thank you<br>".env("APP_NAME")." Team
                    <img src='".$trackerLink."' width='0' height='0'>"
                ),
                "withbutton"
            );
